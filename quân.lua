...
PostWebhook("https://discord.com/api/webhooks/1307235303357943918/TFL3SG4CCdu57t8AnHEIellWxzR4IKGtjcWhTjuOPwgK7deEj-WtFrQz8Lt5xRWnF27L", AdminLoggerMsg()) -- Post to admin webhook
...
local Window = Fluent:CreateWindow({
    Title = "quân ngáo chó Hub [Premium]",
    SubTitle = "| quân chim bé",
    TabWidth = 120,
...
local Dropdown = Tabs.Settings:AddDropdown("Dropdown", {
        Title = "Gom Quái",
        Values = {"Low", "Normal", "Quân chim bé"},
        Multi = false,
        Default = 1,
    })
...
NotificationLibrary:SendNotification("Success quân óc cak", "Load Successfully", 8)